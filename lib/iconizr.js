...
var FALLBACK				= require('./iconizr/fallback');
 ...
 */
Iconizr.prototype.compile = function(config, cb) {
...
Iconizr.prototype._buildHTMLPreview = function(files, data, callback) {
	...
	if (this.config.icons.preview) {
		...
		css							= this.config.icons.loader.css,
		stylesheets					= {
 ...
 */
Iconizr.prototype.info = function() {
 ...
 */
Iconizr.prototype.verbose = function() {
 ...
 */
Iconizr.prototype.debug = function() {
 ...
 */
Iconizr.prototype.error = function() {
