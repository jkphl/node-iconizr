...
var _										= require('lodash'),
	...
	defaultIconsConfig						= {
		...
		threshold							: {
			/**
			 * Threshold for SVG dataURIs
			 *   
			 * @type {Number}
			 */
			svg								: 32768,
			/**
			 * Threshold for fallback dataURIs
			 *   
			 * @type {Number}
			 */
			fallback						: 32768
		...
		loader								: {
			...
			minify							: true,
			/**
			 * Path from your embedding HTML resources to the CSS stylesheets (root relative by default, start with '.' or '..' to make it relative to your HTML document)
			 * 
			 * @type {String}
			 */
			embed							: null,
		...
		/**
		 * Whether to render a set of HTML preview documents
		 * 
		 * @type {Boolean}
		 */
		preview								: false
